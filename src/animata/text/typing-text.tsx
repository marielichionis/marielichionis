...
import AnimatedGradientText from "./animated-gradient-text.tsx";
...
function Type({
  ...
  return (
    <div className={cn("relative font-mono h-full w-ful", className)}>
      {!grow && <div className=" invisible"> {text}</div>}
      <AnimatedGradientText
        className={cn({
          "absolute text-7xl top-10 -left-20 h-full w-ful": !grow,
        })}
      >
        {smooth ? (
          <SmoothEffect
